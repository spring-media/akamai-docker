...
RUN mkdir -p /cli/.akamai-cli/src \
  ...
  && git clone --depth 1 https://github.com/akamai/cli-visitor-prioritization.git /cli/.akamai-cli/src/cli-visitor-prioritization \
  && pip3 install --upgrade pip setuptools \
  && pip3 install -r /cli/.akamai-cli/src/cli-visitor-prioritization/requirements.txt \
  ...
  && rm -rf /cli/.akamai-cli/src/cli-visitor-prioritization/.git
