...
RUN mkdir -p /cli/.akamai-cli/src \
  ...
  && git clone --depth 1 https://github.com/akamai/cli-onboard.git /cli/.akamai-cli/src/cli-onboard \
  && pip3 install --upgrade pip setuptools \
  && pip3 install -r /cli/.akamai-cli/src/cli-onboard/requirements.txt \
